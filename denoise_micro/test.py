...
parser.add_argument("--model", default="./checkpoint/model_micro_net20030.pth", type=str, help="model path")
parser.add_argument("--dataset", default="./test", type=str, help="noisy dataset name, Default: KODAK_noise")
parser.add_argument("--GT", default="./test_label", type=str, help="ground truth dataset name, Default: KODAK")
