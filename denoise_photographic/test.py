...
parser.add_argument("--model", default="./checkpoint/model_denoise_new_unet_net200100.pth", type=str, help="model path")
parser.add_argument("--dataset", default="./test_split", type=str, help="noisy dataset name")
parser.add_argument("--GT", default="./test_label_split", type=str, help="ground truth dataset name")
