...
parser.add_argument("--model", default="./checkpoint/model_denoise_net_30_200_30.pth", type=str, help="model path")
...
with torch.no_grad():
    for image_name in image_list:
        ...
        im_gt = Variable(im_n)
        im_input=np.random.poisson(opt.noise_lambda*im_gt.numpy())/opt.noise_lambda 
