...
def main():
    ...
    file = open('./checksample/mse_n2c_'+str(opt.noise_lambda)+str(opt.nEpochs)+'.txt','w')
    for mse in MSE:
        file.write(mse+'\n')
    file.close()
...
def save_checkpoint(model, epoch):
    model_out_path = "./checkpoint/model_denoise_n2c"+str(opt.noise_lambda)+str(opt.nEpochs)+".pth"
