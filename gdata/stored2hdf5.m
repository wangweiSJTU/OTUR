function [curr_lab_sz] = store2hdf5(filename, labels, create, startloc, chunksz)  
  ...
  if create
    ...
    if ~exist('startloc','var')
      ...
      prev_lab_sz=info.Datasets(1).Dataspace.Size;
  ...
  if nargout
    info=h5info(filename);
    curr_lab_sz=info.Datasets(1).Dataspace.Size;
  end
end
